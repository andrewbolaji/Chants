...
- `functions/src/` Cloud Functions for counters, rate limits, moderation, and account deletion. Vote, comment, like, content-report, and user-report counters are recomputed from stored docs so they self-correct.
