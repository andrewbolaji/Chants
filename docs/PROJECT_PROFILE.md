...
| Paused cleanup retains exact private paths but has no automatic historical replay | Mode changes do not process old jobs, and attempted cleanup is not proof against late admitted bytes | Andrew | Before workers/media open: inventory, bounded replay, transfer drain and retention decision |
