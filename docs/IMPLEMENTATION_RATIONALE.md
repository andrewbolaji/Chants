...
|---|---|
| Current launch-policy and deletion Functions verification | PASS locally: production TypeScript build, all 229 locally runnable tests, and all 24 dedicated Firestore-emulator transaction cases, including the maximum 200-performance and 200-draft deletion pages |
