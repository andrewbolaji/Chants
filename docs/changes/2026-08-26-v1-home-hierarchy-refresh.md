...
Functions, rules, and seed suites were not rerun for this presentation-only block. Their exact merged-main evidence remains GitHub Actions run `32993748570` at `2df9fa0`. The branch's replacement clean-runner CI remains pending packaging.
