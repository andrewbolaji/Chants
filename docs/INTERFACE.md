...
- **Implementation evidence:** Product direction was approved by Andrew on 2026-08-21, and the provenance slice was approved and implemented on 2026-08-22. Submission now requires Already sung or I made this, accepts one optional normalized YouTube or X evidence link, preserves the draft through validation and duplicate review, and presents an explicit View chant, Post mine anyway, or Go back choice. Cards and detail use Terrace Proven, Already sung unverified, Original idea, or neutral Community chant text. External evidence names its destination and says it opens outside Chants. The 390 by 844 origin and evidence form states are retained as goldens. The separate Songbook and Chant Lab browse split remains the next block, and live-device inspection remains pending.
